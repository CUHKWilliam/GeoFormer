...
def do_test(model, dataloader, cur_epoch):
    ...
    with torch.no_grad():
        ...
        for i, batch_input in enumerate(dataloader):
            ...
            outputs = model(batch_input, cur_epoch, training=False, vis_path=vis_path, show=show)
            ...
            instance_inds[class_inds <= 3] = -100
            class_inds_mask = class_inds > 3
            class_inds[np.logical_not((class_inds_mask))] = 0
